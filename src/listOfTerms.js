const terms = [
  ...
  },
  {
    ...
    term: "require()",
    definition:
      "A function used to import modules from other files or Node packages.",
  },
  {
    id: 17,
    term: "express.js",
  ...
  },
  {
    ...
    term: "Links",
    definition:
      "HTML supports two kinds of lists: ordered lists and unordered lists. Within lists each individual list item has its own tag.Unordered Lists:Unordered lists are just lists whose items are denoted with bullet points.Ordered List:Ordered lists' items are denoted with numbers.",
  },
  {
    id: 46,
    term: "Tags & Elements",
